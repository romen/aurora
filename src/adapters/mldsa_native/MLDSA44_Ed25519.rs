...
// Ensure proper null-terminated C string
pub(super) const DESCRIPTION: &CStr = c"mldsa44_ed25519 from mldsa-native and ed25519_dalek";
...
pub(crate) mod capabilities {
    pub(crate) mod tls_sigalg {
        ...
        /// A [_unit-like struct_][rustbook:unit-like-structs] implementing [`TLSSigAlg`] for `mldsa44_ed25519`.
        ///
        ...
        impl TLSSigAlg for TLSSigAlgCap {
            ...
            /// # NOTE
            ///
            /// > For mldsa44_ed25519 we currently refer to ids reserved by <https://datatracker.ietf.org/doc/html/draft-reddy-tls-composite-mldsa-05#name-iana-considerations>
            /// > as IANA does not list mldsa44_ed25519 in the registry yet.
            const SIGALG_IANA_NAME: &CStr = c"mldsa44_ed25519";
            ...
            /// > For mldsa44_ed25519 we currently refer to ids reserved by <https://datatracker.ietf.org/doc/html/draft-reddy-tls-composite-mldsa-05#name-iana-considerations>
            /// > as IANA does not list mldsa44_ed25519 in the registry yet.
            const SIGALG_CODEPOINT: u32 = 0x090A; // 2315 in decimal notation
